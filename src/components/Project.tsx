...
export default function Project({ name, languages, year, link, description }: Props) {
    ...
    return (
        <div>
            ...
            <div>{t('link_repo')} <a href={link} className="hover:underline dark:text-gray-400 hover:text-gray-500 dark:hover:text-slate-50 text-slate-950" target="_blank">{link}</a></div>

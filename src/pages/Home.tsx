...
export default function Home() {
    ...
    <div>
        <CvTitle name={t('cv.section.experience')} cards={[
            {title: t('cv.experience.0.title'), icon: OB_company, company: "Orange Business", date_start: new Date('4 March 2024'), type: t('cv.experience.0.type'), description:(<p>{t('cv.experience.0.description')}</p>)},

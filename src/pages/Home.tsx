...
export default function Home() {
    ...
    <div>
        <CvTitle name={t('cv.section.experience')} cards={[
            {title: t('cv.experience.0.title'), icon: OB_company, company: "Orange Business", date_start: new Date('4 March 2024'), date_end: new Date("31 august 2024"), type: t('cv.experience.0.type'), description:(<p>{t('cv.experience.0.description')}</p>)},
            {title: t('cv.experience.1.title'), icon: OB_company, company: "Orange Business", date_start: new Date('1 May 2023'), date_end: new Date("31 august 2023"), type: t('cv.experience.1.type'), description: <p>{t('cv.experience.1.description')}</p>},
            {title: t('cv.experience.2.title'), icon: greyc_company, company: "Greyc", date_start: new Date('1 May 2022'), date_end: new Date('31 june 2022'), type: t('cv.experience.2.type'), description: <p>{t('cv.experience.2.description')}</p>}
        ]} />
